...
/** Interactive goal/country explorer. The goal catalogue itself is rendered
 *  server-side by page.tsx and passed in, so all 17 goals and their indicators
 *  are in the initial HTML rather than arriving via XHR. */
